...
import { deleteQuestion, fetchClass, fetchCourse, fetchDifficulty, fetchLanguage, fetchQuestion, fetchSection, fetchSubSection, setBreadcrumbItems, setSuccessFalseQuestion, } from "../../store/actions";
...
import { fetchOperatorQuestions, fetchSingleQuestion, updateQuestion } from "helpers/question_helper";
...
const QcReturnQuestion = (props) => {
    ...
    const getQuestions = async () => {
        try {
            const data = await fetchOperatorQuestions();
            if (data?.success) {
                                    ...
                                    <>
                                        ...
                                        <div className="container d-flex align-items-center justify-content-between">
                                            ...
                                            <div className="" style={{ overflowX: "visible" }}>
                                                <Row>
                                                    <h1 className="text-center mb-3 text-danger"> <b className=""> Comment :</b> {questions?.[iterator]?.comment}</h1>
                                                </Row>
                                                <Row className="mb-3">
                                                    <label
